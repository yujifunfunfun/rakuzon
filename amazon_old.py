...
def fetch_amazon_item_price(jan_list):
    ...
    for jan in jan_list:
        ...
        # JAN検索でamzonに商品がない場合
        if item_count == 0:
            amazon_item_list.append([0,'None','None','None','None'])
        # JAN検索でamzonに商品が1つの場合
            ...
            try:
                ...
                amazon_item_list.append([price,buybox_price,1,item_url,category_list])
            ...
            for count ,asin in zip(range(len(asin_list)),asin_list):
                ...
                if count == 0:
                    ...
                    try:
                        ...
                        pass
            amazon_item_list.append([price_ea,buybox_price,package_quantity,item_url,category_list,])
